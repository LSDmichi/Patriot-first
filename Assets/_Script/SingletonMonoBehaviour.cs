...
public class SingletonMonoBehaviour : MonoBehaviour
{
    ...
    static SingletonMonoBehaviour _instance = null;

    // オブジェクト実体の参照（初期参照時、実体の登録も行う）
    static SingletonMonoBehaviour instance
    {
        get { return _instance ?? (_instance = FindObjectOfType<SingletonMonoBehaviour>()); }
    }
